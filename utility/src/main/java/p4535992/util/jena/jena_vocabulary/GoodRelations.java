/* CVS $Id: $ */
package p4535992.util.jena.jena_vocabulary;
import com.hp.hpl.jena.rdf.model.*;
import com.hp.hpl.jena.ontology.*;
 
/**
 * Vocabulary definitions from http://www.heppnetz.de/ontologies/goodrelations/v1.owl 
 * @author Auto-generated by schemagen on 16 lug 2014 10:48 
 */
public class GoodRelations {
    ...
    public static final String VERSION_INFO = "V 1.0, Release 2011-10-01";
    
    /** <p>The gr:PaymentMethod or methods accepted by the gr:BusinessEntity for the 
     *  given gr:Offering.</p>
     */
    ...
    /** <p>This property points from a gr:Offering to additional offerings that can only 
     *  be obtained in combination with the first offering. This can be used to model 
     *  supplements and extensions that are available for a surcharge. Any gr:PriceSpecification 
     *  attached to the secondary offering is to be understood as an additional charge.</p>
     */
    public static final ObjectProperty addOn = m_model.createObjectProperty( "http://purl.org/goodrelations/v1#addOn" );
    
    /** <p>The minimal and maximal amount of time that is required between accepting 
     *  the gr:Offering and the actual usage of the resource or service. This is mostly 
     *  relevant for offers regarding hotel rooms, the rental of objects, or the provisioning 
     *  of services. The duration is specified relatively to the beginning of the 
     *  usage of the contracted object. It is represented by attaching an instance 
     *  of the class gr:QuantitativeValueInteger. The lower and upper boundaries are 
     ...
     *  and the fulfilment or usage.</p>
     */
    public static final ObjectProperty advanceBookingRequirement = m_model.createObjectProperty( "http://purl.org/goodrelations/v1#advanceBookingRequirement" );
    
    /** <p>This property specifies the gr:DeliveryMethod to which the gr:DeliveryChargeSpecification 
     *  applies.</p>
     */
    ...
    /** <p>This property specifies the gr:PaymentMethod to which the gr:PaymentChargeSpecification 
     *  applies.</p>
     */
    ...
    /** <p>This specifies the gr:DeliveryMethod or methods available for a given gr:Offering.</p> */
    ...
    /** <p>This property can be used to indicate the promised delay between the receipt 
     *  of the order and the goods leaving the warehouse. The duration is specified 
     *  by attaching an instance of gr:QuantitativeValueInteger. The lower and upper 
    ...
    /** <p>The depth of the product. Typical unit code(s): CMT for centimeters, INH for 
     *  inches</p>
     */
    public static final ObjectProperty depth = m_model.createObjectProperty( "http://purl.org/goodrelations/v1#depth" );
    
    /** <p>The types of customers (gr:BusinessEntityType) for which the given gr:Offering 
     *  is valid.</p>
     */
    ...
    /** <p>The minimal and maximal duration for which the given gr:Offering or gr:License 
     *  is valid. This is mostly used for offers regarding accommodation, the rental 
     *  of objects, or software licenses. The duration is specified by attaching an 
     *  instance of gr:QuantitativeValue. The lower and upper boundaries are specified 
     ...
     *  duration of the contract or usage.</p>
     */
    public static final ObjectProperty eligibleDuration = m_model.createObjectProperty( "http://purl.org/goodrelations/v1#eligibleDuration" );
    
    /** <p>This property can be used to indicate the transaction volume, in a monetary 
     *  unit, for which the gr:Offering or gr:PriceSpecification is valid. This is 
     *  mostly used to specify a minimal purchasing volume, to express free shipping 
     *  above a certain order volume, or to limit the acceptance of credit cards to 
     *  purchases above a certain amount. The object is a gr:PriceSpecification that 
     *  uses the properties gr:hasMaxCurrencyValue and gr:hasMinCurrencyValue to indicate 
     *  the lower and upper boundaries and gr:hasCurrency to indicate the currency 
     *  using the ISO 4217 standard (3 characters).</p>
     */
    public static final ObjectProperty eligibleTransactionVolume = m_model.createObjectProperty( "http://purl.org/goodrelations/v1#eligibleTransactionVolume" );
    
    /** <p>This ordering relation for qualitative values indicates that the subject is 
     *  equal to the object.</p>
     */
    public static final ObjectProperty equal = m_model.createObjectProperty( "http://purl.org/goodrelations/v1#equal" );
    
    /** <p>This ordering relation for qualitative values indicates that the subject is 
     *  greater than the object.</p>
     */
    public static final ObjectProperty greater = m_model.createObjectProperty( "http://purl.org/goodrelations/v1#greater" );
    
    /** <p>This ordering relation for qualitative values indicates that the subject is 
     *  greater than or equal to the object.</p>
     */
    public static final ObjectProperty greaterOrEqual = m_model.createObjectProperty( "http://purl.org/goodrelations/v1#greaterOrEqual" );
    
    /** <p>This specifies the brand or brands (gr:Brand) associated with a gr:ProductOrService, 
     *  or the brand or brands maintained by a gr:BusinessEntity.</p>
     */
    public static final ObjectProperty hasBrand = m_model.createObjectProperty( "http://purl.org/goodrelations/v1#hasBrand" );
    
    /** <p>This specifies the business function of the gr:Offering, i.e. whether the 
     *  gr:BusinessEntity is offering to sell, to lease, or to repair the particular 
     ...
     *  from unit (Common Code C62), then gr:hasEligibleQuantity refers to units of 
     *  this bundle. In other words, "C62" for "Units or pieces" is usually the appropriate 
    ...
    /** <p>This property specifies the current approximate inventory level for gr:SomeItems. 
     *  The unit of measurement and the point value or interval are indicated using 
     *  the attached gr:QuantitativeValueFloat instance. This property can also be 
     *  attached to a gr:Offering in cases where the included products are not modeled 
     *  in more detail.</p>
     */
    ...
    /** <p>This states that an actual product instance (gr:Individual) or a placeholder 
     *  instance for multiple, unidentified such instances (gr:SomeItems) is one occurence 
     *  of a particular gr:ProductOrServiceModel. Example: myFordT hasMakeAndModel 
     *  FordT.</p>
     */
    ...
    /** <p>This object property links a gr:ProductOrService to the gr:BusinessEntity 
     *  that produces it. Mostly used with gr:ProductOrServiceModel.</p>
     */
    ...
    /** <p>This ordering relation for gr:DayOfWeek indicates that the subject is directly 
     *  followed by the object. Example: Monday hasNext Tuesday Since days of the 
     *  week are a cycle, this property is not transitive.</p>
     */
    public static final ObjectProperty hasNext = m_model.createObjectProperty( "http://purl.org/goodrelations/v1#hasNext" );
    
    /** <p>This specifies the gr:DayOfWeek to which the gr:OpeningHoursSpecification 
     *  is related. Note: Use multiple instances of gr:OpeningHoursSpecification for 
     *  specifying the opening hours for multiple days if the opening hours differ.</p>
     */
    ...
    /** <p>This property links a gr:Location to a gr:OpeningHoursSpecification.</p> */
    ...
    /** <p>This property states that the respective gr:Location is a point of sale for 
     *  the respective gr:BusinessEntity. It allows linking those two types of entities 
     *  without the need for a particular gr:Offering.</p>
     */
    public static final ObjectProperty hasPOS = m_model.createObjectProperty( "http://purl.org/goodrelations/v1#hasPOS" );
    
    /** <p>This ordering relation for gr:DayOfWeek indicates that the subject is directly 
     *  preceeded by the object. Example: Tuesday hasPrevious Monday Since days of 
     *  the week are a cycle, this property is not transitive.</p>
     */
    public static final ObjectProperty hasPrevious = m_model.createObjectProperty( "http://purl.org/goodrelations/v1#hasPrevious" );
    ...
    /** <p>This specifies the gr:WarrantyPromise made by the gr:BusinessEntity for the 
     *  given gr:Offering.</p>
     */
    ...
    /** <p>This states the gr:WarrantyScope of a given gr:WarrantyPromise.</p> */
    ...
    /** <p>The height of the product. Typical unit code(s): CMT for centimeters, INH 
     *  for inches</p>
     */
    public static final ObjectProperty height = m_model.createObjectProperty( "http://purl.org/goodrelations/v1#height" );
     ...
     *  included in an Offering. When linking to an instance of gr:SomeItems or gr:Individual, 
     *  it is equivalent to using a gr:TypeAndQuantityNode with gr:hasUnitOfMeasurement="C62"^^xsd:string 
     *  and gr:amountOfThisGood="1.0"^^xsd:float for that good. When linking to a 
     *  gr:ProductOrServiceModel, it is equivalent to 1. defining an blank node for 
     *  a gr:SomeItems 2. linking that blank node via gr:hasMakeAndModel to the gr:ProductOrServiceModel, 
     *  and 3. linking from the gr:Offering to that blank node using another blank 
     *  node of type gr:TypeAndQuantityNode with gr:hasUnitOfMeasurement="C62"^^xsd:string 
     *  and gr:amountOfThisGood="1.0"^^xsd:float for that good.</p>
     */
    public static final ObjectProperty includes = m_model.createObjectProperty( "http://purl.org/goodrelations/v1#includes" );
    
    /** <p>This object property links a gr:Offering to one or multiple gr:TypeAndQuantityNode 
     *  or nodes that specify the components that are included in the respective offer.</p>
     */
    ...
    /** <p>This states that a particular gr:ProductOrService is an accessory or spare 
    ...
    /** <p>This states that a particular gr:ProductOrService is a consumable for another 
    ...
    /** <p>This states that a given gr:ProductOrService is similar to another product 
    ...
    /** <p>This states that a particular gr:ProductOrServiceModel is a variant of another 
     *  product or service model. It is pretty safe to infer that the variant inherits 
     *  all gr:quantitativeProductOrServiceProperty, gr:qualitativeProductOrServiceProperty, 
     *  and gr:datatypeProductOrServiceProperty values that are defined for the first 
     *  gr:ProductOrServiceModel. Example: foo:Red_Ford_T_Model gr:isVariantOf foo:Ford_T_Model</p>
     */
    public static final ObjectProperty isVariantOf = m_model.createObjectProperty( "http://purl.org/goodrelations/v1#isVariantOf" );
    
    /** <p>This ordering relation for gr:QualitativeValue pairs indicates that the subject 
     *  is lesser than the object.</p>
     */
    public static final ObjectProperty lesser = m_model.createObjectProperty( "http://purl.org/goodrelations/v1#lesser" );
    
    /** <p>This ordering relation for gr:QualitativeValue pairs indicates that the subject 
     *  is lesser than or equal to the object.</p>
     */
    public static final ObjectProperty lesserOrEqual = m_model.createObjectProperty( "http://purl.org/goodrelations/v1#lesserOrEqual" );
    
    /** <p>This ordering relation for gr:QualitativeValue pairs indicates that the subject 
     *  is not equal to the object.</p>
     */
    public static final ObjectProperty nonEqual = m_model.createObjectProperty( "http://purl.org/goodrelations/v1#nonEqual" );
    
    /** <p>This links a gr:BusinessEntity to the offers (gr:Offering) it makes. If you 
     *  want to express interest in receiving offers, use gr:seeks instead.</p>
     */
    public static final ObjectProperty offers = m_model.createObjectProperty( "http://purl.org/goodrelations/v1#offers" );
    
    /** <p>This property indicates that a particular person or business owns a particular 
     *  product. It can be used to expose the products in one's posession in order 
     *  to empower recommender systems to suggest matching offers. Note that the product 
     *  must be an instance of the class gr:Individual. This property can also be 
     *  safely applied to foaf:Agent instances.</p>
     */
    public static final ObjectProperty owns = m_model.createObjectProperty( "http://purl.org/goodrelations/v1#owns" );
    
    /** <p>This property indicates that the subject is a previous, often discontinued 
     *  variant of the gr:ProductOrServiceModel used as the object. Example: Golf 
     *  III predecessorOf Golf IV This relation is transitive.</p>
     */
    public static final ObjectProperty predecessorOf = m_model.createObjectProperty( "http://purl.org/goodrelations/v1#predecessorOf" );
    
    /** <p>This is the super property of all qualitative properties for products and 
     *  services. All properties in product or service ontologies for which gr:QualitativeValue 
     *  instances are specified are subproperties of this property.</p>
     */
    ...
    /** <p>This links a gr:BusinessEntity to gr:Offering nodes that describe what the 
     *  business entity is interested in (i.e., the buy side). If you want to express 
     *  interest in offering something, use gr:offers instead. Note that this substitutes 
     *  the former gr:BusinessFunction gr:Buy, which is now deprecated.</p>
     */
    public static final ObjectProperty seeks = m_model.createObjectProperty( "http://purl.org/goodrelations/v1#seeks" );
    
    /** <p>This property indicates that the subject is a newer, often updated or improved 
     *  variant of the gr:ProductOrServiceModel used as the object. Example: Golf 
     *  III successorOf Golf II This relation is transitive.</p>
     */
    public static final ObjectProperty successorOf = m_model.createObjectProperty( "http://purl.org/goodrelations/v1#successorOf" );
    
    /** <p>This specifies the gr:ProductOrService that the gr:TypeAndQuantityNode is 
     *  referring to.</p>
     */
    ...
    /** <p>The weight of the gr:ProductOrService. Typical unit code(s): GRM for gram, 
     *  KGM for kilogram, LBR for pound</p>
     */
    public static final ObjectProperty weight = m_model.createObjectProperty( "http://purl.org/goodrelations/v1#weight" );
    
    /** <p>The width of the gr:ProductOrService. Typical unit code(s): CMT for centimeters, 
     *  INH for inches</p>
     */
    public static final ObjectProperty width = m_model.createObjectProperty( "http://purl.org/goodrelations/v1#width" );
    
    /** <p>This property specifies the quantity of the goods included in the gr:Offering 
     *  via this gr:TypeAndQuantityNode. The quantity is given in the unit of measurement 
     *  attached to the gr:TypeAndQuantityNode.</p>
     */
    ...
    /** <p>This property specifies the end of the availability of the gr:ProductOrService 
     ...
     *  the offer is valid and can be accepted. Example: I offer to lease my boat 
     *  for the period of August 1 - August 31, 2010, but you must accept by offer 
     *  no later than July 15. A time-zone should be specified. For a time in GMT/UTC, 
     *  simply add a "Z" following the time: 2008-05-30T09:30:10Z. Alternatively, 
    ...
    /** <p>This property specifies the beginning of the availability of the gr:ProductOrService 
     *  included in the gr:Offering. The difference to the properties gr:validFrom 
     *  and gr:validThrough is that those specify the period of time during which 
     *  the offer is valid and can be accepted. Example: I offer to lease my boat 
     *  for the period of August 1 - August 31, 2010, but you must accept by offer 
     ...
     *  UN/CEFACT code attached to the gr:UnitPriceSpecification via the gr:hasUnitOfMeasurement 
     *  property. Examples: - The price for gasoline is 4 USD per gallon at the pump, 
     *  but you will be charged in units of 0.1 gallons. - The price for legal consulting 
     *  is 100 USD per hour, but you will be charged in units of 15 minutes. This 
     *  property makes sense only for instances of gr:Offering that include not more 
     *  than one type of good or service.</p>
     */
    public static final DatatypeProperty billingIncrement = m_model.createDatatypeProperty( "http://purl.org/goodrelations/v1#billingIncrement" );
    
    /** <p>The name of a category to which this gr:ProductOrService, gr:Offering, gr:BusinessEntity, 
     *  or gr:Location belongs. Note 1: For products, it is better to add an rdf:type 
    ...
    /** <p>The closing hour of the gr:Location on the given gr:DayOfWeek. If no time-zone 
     *  suffix is included, the time is given in the local time valid at the gr:Location. 
     *  For a time in GMT/UTC, simply add a "Z" following the time: 09:30:10Z. Alternatively, 
     *  you can specify an offset from the UTC time by adding a positive or negative 
     *  time following the time: 09:30:10-09:00 09:30:10+09:00. Note 1: Use 00:00:00 
     *  for the first second of the respective day and 23:59:59 for the last second 
     *  of that day. Note 2: If a store opens at 17:00 on Saturdays and closes at 
     *  03:00:00 a.m. next morning, use two instances of this class, one with 17:00:00 
     *  - 23:59:59 for Saturday and another one with 00:00:00 - 03:00:00 for Sunday. 
     *  Note 3: If the shop re-opens on the same day of the week or set of days of 
     *  the week, you must create a second instance of gr:OpeningHoursSpecification.</p>
     */
    ...
    public static final DatatypeProperty color = m_model.createDatatypeProperty( "http://purl.org/goodrelations/v1#color" );
    
    /** <p>A textual description of the condition of the product or service, or the products 
     *  or services included in the offer (when attached to a gr:Offering)</p>
     */
    public static final DatatypeProperty condition = m_model.createDatatypeProperty( "http://purl.org/goodrelations/v1#condition" );
    
    /** <p>This property is the super property for all pure datatype properties that 
     *  can be used to describe a gr:ProductOrService. In products and services ontologies, 
     *  only such properties that are no quantitative properties and that have no 
     *  predefined gr:QualitativeValue instances are subproperties of this property. 
     *  In practice, this refers to a few integer properties for which the integer 
     *  value represents qualitative aspects, for string datatypes (as long as no 
     *  predefined values exist), for boolean datatype properties, and for dates and 
     *  times.</p>
     */
    ...
    /** <p>A short textual description of the resource. This property is semantically 
     *  equivalent to rdfs:comment and just meant as a handy shortcut for marking 
     *  up data.</p>
     */
    ...
    /** <p>This property specifies the duration of the gr:WarrantyPromise in months.</p> */
     ...
     *  gr:Offering, gr:License, or gr:DeliveryChargeSpecification is valid using 
     *  the two-character version of ISO 3166-1 (ISO 3166-1 alpha-2) for regions or 
     *  ISO 3166-2 , which breaks down the countries from ISO 3166-1 into administrative 
     *  subdivisions. Important: Do NOT use 3-letter ISO 3166-1 codes!</p>
     */
    ...
    /** <p>The currency for all prices in the gr:PriceSpecification given using the ISO 
     ...
     *  to the respective gr:PriceSpecification etc. For a gr:UnitPriceSpecification, 
     *  this is the price for one unit or bundle (as specified in the unit of measurement 
     *  of the unit price specification) of the respective gr:ProductOrService. For 
     *  a gr:DeliveryChargeSpecification or a gr:PaymentChargeSpecification, it is 
     *  the price per delivery or payment. GoodRelations also supports giving price 
     *  information as intervals only. If this is needed, use gr:hasMaxCurrencyValue 
     *  for the upper bound and gr:hasMinCurrencyValue for the lower bound. Using 
     *  gr:hasCurrencyValue sets the upper and lower bounds to the same given value, 
     *  i.e., x gr:hasCurrencyValue y implies x gr:hasMinCurrencyValue y, x gr:hasMaxCurrencyValue 
     *  y.</p>
     */
    ...
    /** <p>The Dun &amp; Bradstreet DUNS number for identifying a gr:BusinessEntity. 
     *  The Dun &amp; Bradstreet DUNS is a nine-digit number used to identify legal 
     *  entities (but usually not branches or locations of logistical importance only).</p>
     */
    public static final DatatypeProperty hasDUNS = m_model.createDatatypeProperty( "http://purl.org/goodrelations/v1#hasDUNS" );
    
    /** <p>The EAN�UCC-13 code of the given gr:ProductOrService or gr:Offering. This 
     *  code is now officially called GTIN-13 (Global Trade Identifier Number) or 
     *  EAN�UCC-13. Former 12-digit UPC codes can be converted into EAN�UCC-13 code 
     *  by simply adding a preceeding zero. Note 1: When using this property for searching 
     *  by 12-digit UPC codes, you must add a preceeding zero digit. Note 2: As of 
     *  January 1, 2007, the former ISBN numbers for books etc. have been integrated 
     *  into the EAN�UCC-13 code. For each old ISBN-10 code, there exists a proper 
     *  translation into EAN�UCC-13 by adding "978" or "979" as prefix. Since the 
     *  old ISBN-10 is now deprecated, GoodRelations does not provide a property for 
     *  ISBNs.</p>
     */
    ...
    /** <p>The Global Trade Item Number (GTIN-14) of the given gr:ProductOrService or 
     *  gr:Offering.</p>
     */
    public static final DatatypeProperty hasGTIN_14 = m_model.createDatatypeProperty( "http://purl.org/goodrelations/v1#hasGTIN-14" );
    
    /** <p>The 8-digit Global Trade Item Number (GTIN-8) of the given gr:ProductOrService 
     *  or gr:Offering, also known as EAN/UCC-8 (8-digit EAN).</p>
     */
    public static final DatatypeProperty hasGTIN_8 = m_model.createDatatypeProperty( "http://purl.org/goodrelations/v1#hasGTIN-8" );
     ...
     *  (ISIC), Revision 4 code for a particular gr:BusinessEntity or gr:Location. 
     *  See http://unstats.un.org/unsd/cr/registry/isic-4.asp for more information. 
     *  Note: While ISIC codes are sometimes misused for classifying products or services, 
     *  they are designed and suited only for classifying business establishments.</p>
     */
    public static final DatatypeProperty hasISICv4 = m_model.createDatatypeProperty( "http://purl.org/goodrelations/v1#hasISICv4" );
    
    /** <p>The Manufacturer Part Number or MPN is a unique identifier for a product, 
     *  service, or bundle from the perspective of a particular manufacturer. MPNs 
     *  can be assigned to products or product datasheets, or bundles. Accordingly, 
     *  the domain of this property is the union of gr:ProductOrService (the common 
     *  superclass of goods and datasheets), and gr:Offering. Important: Be careful 
     *  when assuming two products or services instances or offering instances to 
     *  be identical based on the MPN. Since MPNs are unique only for the same gr:BusinessEntity, 
     *  this holds only when the two MPN values refer to the same gr:BusinessEntity. 
     *  Such can be done by taking into account the provenance of the data. Usually, 
     *  the properties gr:hasEAN_UCC-13 and gr:hasGTIN-14 are much more reliable identifiers, 
     *  because they are globally unique. See also http://en.wikipedia.org/wiki/Part_number</p>
     */
    public static final DatatypeProperty hasMPN = m_model.createDatatypeProperty( "http://purl.org/goodrelations/v1#hasMPN" );
     ...
     *  relevant details are attached to the respective gr:PriceSpecification etc. 
     *  For a gr:UnitPriceSpecification, this is the UPPER BOUND for the price for 
     *  one unit or bundle (as specified in the unit of measurement of the unit price 
     *  specification) of the respective gr:ProductOrService. For a gr:DeliveryChargeSpecification 
     *  or a gr:PaymentChargeSpecification, it is the UPPER BOUND of the price per 
     *  delivery or payment. Using gr:hasCurrencyValue sets the upper and lower bounds 
     *  to the same given value, i.e., x gr:hasCurrencyValue y implies x gr:hasMinCurrencyValue 
     *  y, x gr:hasMaxCurrencyValue y.</p>
     */
    ...
    /** <p>This property captures the upper limit of a gr:QuantitativeValue instance.</p> */
    ...
    /** <p>This property captures the upper limit of a gr:QuantitativeValueFloat instance.</p> */
    ...
    /** <p>This property captures the upper limit of a gr:QuantitativeValueInteger instance.</p> */
     ...
     *  RANGE per unit, shipping charges, or payment charges. The currency and other 
     *  relevant details are attached to the respective gr:PriceSpecification etc. 
     *  For a gr:UnitPriceSpecification, this is the LOWER BOUND for the price for 
     *  one unit or bundle (as specified in the unit of measurement of the unit price 
     *  specification) of the respective gr:ProductOrService. For a gr:DeliveryChargeSpecification 
    ...
    /** <p>This property captures the lower limit of a gr:QuantitativeValue instance.</p> */
    ...
    /** <p>This property captures the lower limit of a gr:QuantitativeValueFloat instance.</p> */
    ...
    /** <p>This property captures the lower limit of a gr:QuantitativeValueInteger instance.</p> */
     ...
     *  gr:BusinessEntity. See http://www.census.gov/eos/www/naics/ for more details. 
     ...
     *  domain of gr:hasStockKeepingUnit is the union of the classes gr:Offering and 
     *  gr:ProductOrService. If attached to a gr:Offering, the SKU will usually reflect 
     *  a merchant-specific identifier, i.e. one valid only for that particular retailer 
     *  or shop. If attached to a gr:ProductOrServiceModel, the SKU can reflect either 
     *  the identifier used by the merchant or the part number used by the official 
     *  manufacturer of that part. For the latter, gr:hasMPN is a better choice. Important: 
     *  Be careful when assuming two products or services instances or offering instances 
     *  to be identical based on the SKU. Since SKUs are unique only for the same 
     *  gr:BusinessEntity, this can be assumed only when you are sure that the two 
     *  SKU values refer to the same business entity. Such can be done by taking into 
     *  account the provenance of the data. As long as instances of gr:Offering are 
     *  concerned, you can also check that the offerings are being offered by the 
     *  same gr:Business Entity. Usually, the properties gr:hasEAN_UCC-13 and gr:hasGTIN-14 
     *  are much more reliable identifiers, because they are globally unique. See 
     *  also http://en.wikipedia.org/wiki/Stock_Keeping_Unit.</p>
     */
    ...
    /** <p>The unit of measurement for a gr:QuantitativeValue, a gr:UnitPriceSpecification, 
     *  or a gr:TypeAndQuantityNode given using the UN/CEFACT Common Code (3 characters).</p>
     */
    ...
    /** <p>This subproperty specifies that the upper and lower limit of the given gr:QuantitativeValue 
     *  are identical and have the respective value. It is a shortcut for such cases 
     *  where a quantitative property is (at least practically) a single point value 
     *  and not an interval.</p>
     */
    public static final DatatypeProperty hasValue = m_model.createDatatypeProperty( "http://purl.org/goodrelations/v1#hasValue" );
    
    /** <p>This subproperty specifies that the upper and lower limit of the given gr:QuantitativeValueFloat 
     *  are identical and have the respective float value. It is a shortcut for such 
     *  cases where a quantitative property is (at least practically) a single point 
     *  value and not an interval.</p>
     */
    ...
    /** <p>This subproperty specifies that the upper and lower limit of the given gr:QuantitativeValueInteger 
     *  are identical and have the respective integer value. It is a shortcut for 
     *  such cases where a quantitative property is (at least practically) a single 
    ...
    /** <p>This boolean attribute indicates whether a gr:UnitPriceSpecification is a 
     *  list price (usually a vendor recommendation) or not. "true" indicates it is 
     *  a list price, "false" indicates it is not. DEPRECATED. Use the gr:priceType 
     *  property instead.</p>
     */
    ...
    /** <p>The legal name of the gr:BusinessEntity.</p> */
    public static final DatatypeProperty legalName = m_model.createDatatypeProperty( "http://purl.org/goodrelations/v1#legalName" );
    
    /** <p>A short text describing the respective resource. This property is semantically 
     *  equivalent to dcterms:title and rdfs:label and just meant as a handy shortcut 
     *  for marking up data.</p>
     */
    public static final DatatypeProperty name = m_model.createDatatypeProperty( "http://purl.org/goodrelations/v1#name" );
    
    /** <p>The opening hour of the gr:Location on the given gr:DayOfWeek. If no time-zone 
     *  suffix is included, the time is given in the local time valid at the gr:Location. 
     *  For a time in GMT/UTC, simply add a "Z" following the time: 09:30:10Z. Alternatively, 
     *  you can specify an offset from the UTC time by adding a positive or negative 
     *  time following the time: 09:30:10-09:00 or 09:30:10+09:00. Note 1: Use 00:00:00 
     *  for the first second of the respective day and 23:59:59 for the last second 
     *  of that day. Note 2: If a store opens at 17:00 on Saturdays and closes at 
     *  03:00:00 a.m. next morning, use 17:00:00 - 23:59:59 for Saturday and 00:00:00 
     *  - 03:00:00 for Sunday. Note 3: If the shop re-opens on the same day of the 
     *  week or set of days of the week, you must create a second instance of gr:OpeningHoursSpecification.</p>
     */
     ...
     *  Note that serial number are unique only for the same brand or the same model, 
     *  so you cannot infer from two occurrences of the same serial number that the 
     *  objects to which they are attached are identical. This property can also be 
     *  attached to a gr:Offering in cases where the included products are not modeled 
     *  in more detail.</p>
     */
    ...
    /** <p>This property specifies the beginning of the validity of the gr:Offering, 
     *  gr:PriceSpecification, gr:License, or gr:OpeningHoursSpecification. A time-zone 
     ...
     *  or 2008-05-30T09:30:10+09:00. Note: If multiple contradicting instances of 
     *  a gr:Offering, gr:PriceSpecification, or gr:OpeningHoursSpecification exist, 
     ...
     *  the one with the shorter validity span ranks higher.</p>
     */
    public static final DatatypeProperty validFrom = m_model.createDatatypeProperty( "http://purl.org/goodrelations/v1#validFrom" );
    
    /** <p>This property specifies the end of the validity of the gr:Offering, gr:PriceSpecification, 
     *  gr:License, or gr:OpeningHoursSpecification. A time-zone should be specified. 
     *  For a time in GMT/UTC, simply add a "Z" following the time: 2008-05-30T09:30:10Z. 
     *  Alternatively, you can specify an offset from the UTC time by adding a positive 
     *  or negative time following the time: 2008-05-30T09:30:10-09:00 or 2008-05-30T09:30:10+09:00. 
     *  Note 1: If multiple contradicting instances of a gr:Offering, gr:PriceSpecification, 
     *  or gr:OpeningHoursSpecification exist, it is a good heuristics to assume that 
     *  1. Information with validity information for the respective period of time 
     *  ranks higher than information without validity information. 2. Among conflicting 
     *  nodes both having validity information, the one with the shorter validity 
     *  span ranks higher. Note 2: For Google, attaching a gr:validThrough statement 
     *  to a gr:UnitPriceSpecification is mandatory.</p>
     */
     ...
     *  in the price of the gr:PriceSpecification or not. Note: This is a simple representation 
     *  which may not properly reflect all details of local taxation.</p>
     */
    ...
    /** <p>The Value-added Tax ID of the gr:BusinessEntity. See http://en.wikipedia.org/wiki/Value_added_tax_identification_number 
     *  for details.</p>
     */
    public static final DatatypeProperty vatID = m_model.createDatatypeProperty( "http://purl.org/goodrelations/v1#vatID" );
     ...
     */
    public static final AnnotationProperty displayPosition = m_model.createAnnotationProperty( "http://purl.org/goodrelations/v1#displayPosition" );
    
    /** <p>The URI of a SOAP or REST Web Service from which additional information about 
     *  the gr:BusinessEntity, gr:Offering, gr:PriceSpecification, or gr:ProductOrService, 
     *  or any other element, can be obtained. The recommended range is xsd:anyURI 
     *  i.e., the URI of a SOAP or REST Web Service. In principle, any existing or 
     *  upcoming vocabulary for Web Services can be used in combination with GoodRelations, 
     *  because the association between (a) the service description and (b) the GoodRelations 
     *  description can be found via the Web Service URI value used with this gr:relatedWebService 
     *  property.</p>
     */
    ...
    /** <p>DEPRECATED - This class is superseded by gr:Individual. Replace all occurrences 
     *  of gr:ActualProductOrServiceInstance by gr:Individual, if possible.</p>
     */
    ...
    /** <p>A brand is the identity of a specific product, service, or business. Use foaf:logo 
     *  for attaching a brand logo and gr:name or rdfs:label for attaching the brand 
     *  name. (Source: Wikipedia, the free encyclopedia, see http://en.wikipedia.org/wiki/Brand)</p>
     */
    public static final OntClass Brand = m_model.createClass( "http://purl.org/goodrelations/v1#Brand" );
    
    /** <p>An instance of this class represents the legal agent making (or seeking) a 
     *  particular offering. This can be a legal body or a person. A business entity 
     ...
     *  combination thereof, of a gr:BusinessEntity. From the ontological point of 
     *  view, business entity types are mostly roles that a business entity has in 
     *  the market. Business entity types are important for specifying eligible customers, 
     *  since a gr:Offering is often valid only for business entities of a certain 
     *  size, legal structure, or role in the value chain. Examples: Consumers, Retailers, 
     *  Wholesalers, or Public Institutions</p>
     */
     ...
     *  bundle of rights) offered by the gr:BusinessEntity on the gr:ProductOrService 
     ...
     *  or installation. Licenses and other proprietary specifications of access rights 
     *  are also instances of this class. Examples: A particular offering made by 
     *  Miller Rentals Ltd. says that they (1) sell Volkswagen Golf convertibles, 
     *  (2) lease out a particular Ford pick-up truck, and (3) dispose car wrecks 
     *  of any make and model.</p>
     */
    public static final OntClass BusinessFunction = m_model.createClass( "http://purl.org/goodrelations/v1#BusinessFunction" );
    
    /** <p>The day of the week, used to specify to which day the opening hours of a gr:OpeningHoursSpecification 
     *  refer. Examples: Monday, Tuesday, Wednesday,...</p>
     */
     ...
     *  additional costs asked for the delivery of a given gr:Offering using a particular 
     *  gr:DeliveryMethod by the respective gr:BusinessEntity. A delivery charge specification 
     ...
     *  sales taxes, namely VAT. A gr:Offering may be linked to multiple gr:DeliveryChargeSpecification 
     *  nodes that specify alternative charges for disjoint combinations of target 
     *  countries or regions, and delivery methods. Examples: Delivery by direct download 
     *  is free of charge worldwide, delivery by UPS to Germany is 10 Euros per order, 
     *  delivery by mail within the US is 5 Euros per order. The total amount of this 
     *  charge is specified as a float value of the gr:hasCurrencyValue property. 
     ...
     *  property. The gr:DeliveryMethod to which this charge applies is specified 
     *  using the gr:appliesToDeliveryMethod object property. The region or regions 
     *  to which this charge applies is specified using the gr:eligibleRegions property, 
     *  which uses ISO 3166-1 and ISO 3166-2 codes. If the price can only be given 
     *  as a range, use gr:hasMaxCurrencyValue and gr:hasMinCurrencyValue for the 
     *  upper and lower bounds. Important: When querying for the price, always use 
     *  gr:hasMaxCurrencyValue and gr:hasMinCurrencyValue.</p>
     */
     ...
     *  or service to the destination of fulfilment chosen by the customer. Delivery 
     *  methods are characterized by the means of transportation used, and by the 
     *  organization or group that is the contracting party for the sending gr:BusinessEntity 
     *  (this is important, since the contracted party may subcontract the fulfilment 
     *  to smaller, regional businesses). Examples: Delivery by mail, delivery by 
     *  direct download, delivery by UPS</p>
     */
    ...
    /** <p>A gr:Individual is an actual product or service instance, i.e., a single identifiable 
     *  object or action that creates some increase in utility (in the economic sense) 
     *  for the individual possessing or using this very object (product) or for the 
     *  individual in whose favor this very action is being taken (service). Products 
     *  or services are types of goods in the economic sense. For an overview of goods 
     *  and commodities in economics, see Milgate (1987). Examples: MyThinkpad T60, 
     *  the pint of beer standing in front of me, my Volkswagen Golf, the haircut 
     *  that I received or will be receiving at a given date and time. Note 1: In 
     *  many cases, product or service instances are not explicitly exposed on the 
     *  Web but only claimed to exist (i.e. existentially quantified). In this case, 
     *  use gr:SomeItems. Note 2: This class is the new, shorter form of the former 
     *  gr:ActualProductOrServiceInstance. Compatibility with schema.org: This class 
     *  is a subclass of http://schema.org/Product.</p>
     */
    public static final OntClass Individual = m_model.createClass( "http://purl.org/goodrelations/v1#Individual" );
     ...
     *  Business Function Lease Out of cars from two locations, one in Fort Myers, 
     *  Florida, and one in Boston, Massachussetts. Both stations are open 7:00 - 
     *  23:00 Mondays through Saturdays. Note: Typical address standards (vcard) and 
     *  location data (geo, WGC84) should be attached to a gr:Location node. Since 
     *  there already exist established vocabularies for this, the GoodRelations ontology 
     *  does not provide respective attributes. Instead, the use of respective vocabularies 
     *  is recommended. However, the gr:hasGlobalLocationNumber property is provided 
     *  for linking to public identifiers for business locations. Compatibility with 
     *  schema.org: This class is equivalent to http://schema.org/Place.</p>
     */
    public static final OntClass Location = m_model.createClass( "http://purl.org/goodrelations/v1#Location" );
    
    /** <p>DEPRECATED - This class is superseded by gr:Location. Replace all occurrences 
     *  of gr:LocationOfSalesOrServiceProvisioning by gr:Location, if possible.</p>
     */
     ...
     *  which OWL cannot represent. DEPRECATED. Do not use this class in data or queries.</p>
     */
     ...
     *  exclusive, announcement by a gr:BusinessEntity to provide (or seek) a certain 
     *  gr:BusinessFunction for a certain gr:ProductOrService to a specified target 
     *  audience. An offering is specified by the type of product or service or bundle 
     *  it refers to, what business function is being offered (sales, rental, ...), 
     *  and a set of commercial properties. It can either refer to (1) a clearly specified 
     *  instance (gr:Individual), (2) to a set of anonymous instances of a given type 
     *  (gr:SomeItems), (3) a product model specification (gr:ProductOrServiceModel), 
     *  see also section 3.3.3 of the GoodRelations Technical Report. An offering 
     *  may be constrained in terms of the eligible type of business partner, countries, 
     *  quantities, and other commercial properties. The definition of the commercial 
     *  properties, the type of product offered, and the business function are explained 
     *  in other parts of this vocabulary in more detail. Example: Peter Miller offers 
     *  to repair TV sets made by Siemens, Volkswagen Innsbruck sells a particular 
     *  instance of a Volkswagen Golf at $10,000. Compatibility with schema.org: This 
     *  class is a superclass to http://schema.org/Offer, since gr:Offering can also 
     *  represent demand.</p>
     */
    public static final OntClass Offering = m_model.createClass( "http://purl.org/goodrelations/v1#Offering" );
    
    /** <p>This is a conceptual entity that holds together all information about the 
     *  opening hours on a given day (gr:DayOfWeek).</p>
     */
     ...
     *  costs asked for settling the payment after accepting a given gr:Offering using 
     *  a particular gr:PaymentMethod. A payment charge specification is characterized 
     ...
     *  this charge includes local sales taxes, namely VAT. A gr:Offering may be linked 
     ...
     *  of the gr:hasCurrencyValue property. The currency is specified via the gr:hasCurrency 
     *  datatype property. Whether the price includes VAT or not is indicated by the 
     *  gr:valueAddedTaxIncluded datatype property. The gr:PaymentMethod to which 
     *  this charge applies is specified using the gr:appliesToPaymentMethod object 
     *  property. If the price can only be given as a range, use gr:hasMaxCurrencyValue 
     *  and gr:hasMinCurrencyValue for the upper and lower bounds. Important: When 
     *  querying for the price, always use gr:hasMaxCurrencyValue and gr:hasMinCurrencyValue.</p>
     */
     ...
     *  accepted by a gr:BusinessEntity. Examples: VISA, MasterCard, Diners, cash, 
     *  or bank transfer in advance.</p>
     */
    public static final OntClass PaymentMethod = m_model.createClass( "http://purl.org/goodrelations/v1#PaymentMethod" );
    
    /** <p>The subclass of gr:PaymentMethod represents all variants and brands of credit 
     ...
     *  by a gr:Business Entity. Examples: VISA, MasterCard, or American Express.</p>
     */
     ...
     *  (gr:Individual), a placeholder instance for unknown instances of a mass-produced 
     *  commodity (gr:SomeItems), or a model / prototype specification (gr:ProductOrServiceModel). 
     *  When in doubt, use gr:SomeItems. Examples: a) MyCellphone123, i.e. my personal, 
     *  tangible cell phone (gr:Individual) b) Siemens1234, i.e. the Siemens cell 
     *  phone make and model 1234 (gr:ProductOrServiceModel) c) dummyCellPhone123 
     *  as a placeholder for actual instances of a certain kind of cell phones (gr:SomeItems) 
     *  Note: Your first choice for specializations of gr:ProductOrService should 
     *  be http://www.productontology.org. Compatibility with schema.org: This class 
     *  is (approximately) equivalent to http://schema.org/Product.</p>
     */
    public static final OntClass ProductOrService = m_model.createClass( "http://purl.org/goodrelations/v1#ProductOrService" );
    
    /** <p>A product or service model is a intangible entity that specifies some characteristics 
     *  of a group of similar, usually mass-produced products, in the sense of a prototype. 
     *  In case of mass-produced products, there exists a relation gr:hasMakeAndModel 
    ...
    /** <p>DEPRECATED - This class is superseded by gr:SomeItems. Replace all occurrences 
     *  of gr:ProductOrServicesSomeInstancesPlaceholder by gr:SomeItems, if possible.</p>
     */
    ...
    /** <p>A qualitative value is a predefined value for a product characteristic. Examples: 
     *  the color "green" or the power cord plug type "US"; the garment sizes "S", 
     *  "M", "L", and "XL". Note: Value sets are supported by creating subclasses 
     *  of this class. Ordinal relations between values (gr:greater, gr:lesser, ...) 
     *  are provided directly by GoodRelations. Compatibility with schema.org: This 
     *  class is equivalent to http://schema.org/Enumeration.</p>
     */
     ...
     *  a certain gr:quantitativeProductOrServiceProperty in terms of the lower and 
     *  upper bounds for a particular gr:ProductOrService. It is to be interpreted 
     ...
     *  point value. Example: a weight between 10 and 25 kilogramms, a length between 
     *  10 and 15 milimeters. Compatibility with schema.org: This class is equivalent 
     *  to http://schema.org/Quantity.</p>
     */
     ...
     *  maximal value, and a unit of measurement. Examples: The intervals "between 
     *  10.0 and 25.4 kilogramms" or "10.2 and 15.5 milimeters". Compatibility with 
     *  schema.org: This class is a subclass of http://schema.org/Quantity.</p>
     */
     ...
     *  of a product. This instance is usually characterized by a minimal value, a 
     *  maximal value, and a unit of measurement. Example: A seating capacity between 
     ...
     *  persons. Compatibility with schema.org: This class is a subclass of http://schema.org/Quantity.</p>
     */
     ...
     */
    public static final OntClass SomeItems = m_model.createClass( "http://purl.org/goodrelations/v1#SomeItems" );
    
    /** <p>This class collates all the information about a gr:ProductOrService included 
     *  in a bundle. If a gr:Offering contains just one item, you can directly link 
     *  from the gr:Offering to the gr:ProductOrService using gr:includes. If the 
     *  offering contains multiple items, use an instance of this class for each component 
     *  to indicate the quantity, unit of measurement, and type of product, and link 
     *  from the gr:Offering via gr:includesObject. Example: An offering may include 
     *  of 100g of Butter and 1 kg of potatoes, or 1 cell phone and 2 headsets.</p>
     */
     ...
     *  (3) whether this prices includes local sales taxes, namely VAT. Example: The 
     *  price, including VAT, for 1 kg of a given material is 5 Euros per kg for 0 
     *  - 5 kg and 4 Euros for quantities above 5 kg. The eligible quantity interval 
     *  for a given price is specified using the object property gr:hasEligibleQuantity, 
     *  which points to an instance of gr:QuantitativeValue. The currency is specified 
     *  using the gr:hasCurrency property, which points to an ISO 4217 currency code. 
     *  The unit of measurement for the eligible quantity is specified using the gr:hasUnitOfMeasurement 
     ...
     *  valid unit of measurement. You can assume that the price is given per unit 
     *  or piece if there is no gr:hasUnitOfMeasurement property attached to the price. 
     *  Whether VAT and sales taxes are included in this price is specified using 
     *  the property gr:valueAddedTaxIncluded (xsd:boolean). The price per unit of 
     *  measurement is specified as a float value of the gr:hasCurrencyValue property. 
     *  The currency is specified via the gr:hasCurrency datatype property. Whether 
     *  the price includes VAT or not is indicated by the gr:valueAddedTaxIncluded 
     *  datatype property. The property priceType can be used to indicate that the 
     *  price is a retail price recommendation only (i.e. a list price). If the price 
     ...
     *  use gr:hasMaxCurrencyValue and gr:hasMinCurrencyValue. Note 1: Due to the 
     *  complexity of pricing scenarios in various industries, it may be necessary 
     *  to create extensions of this fundamental model of price specifications. Such 
     *  can be done easily by importing and refining the GoodRelations ontology. Note 
     *  2: For Google, attaching a gr:validThrough statement to a gr:UnitPriceSpecification 
     *  is mandatory.</p>
     */
     ...
     *  gr:hasWarrantyPromise. A Warranty promise is an entity representing the duration 
    ...
    /** <p>The gr:BusinessEntityType representing such agents that are themselves offering 
    ...
    /** <p>This gr:BusinessFunction indicates that the gr:BusinessEntity is in general 
     *  interested in purchasing the specified gr:ProductOrService. DEPRECATED. Use 
     *  gr:seeks instead.</p>
     */
    public static final Individual Buy = m_model.createIndividual( "http://purl.org/goodrelations/v1#Buy", BusinessFunction );
    
    /** <p>Payment by bank transfer in advance, i.e., the offering gr:BusinessEntity 
     *  will inform the buying party about their bank account details and will deliver 
    ...
    /** <p>Payment by bank transfer after delivery, i.e., the offering gr:BusinessEntity 
    ...
    /** <p>Payment by sending a check in advance, i.e., the offering gr:BusinessEntity 
    ...
    /** <p>This gr:BusinessFunction indicates that the gr:BusinessEntity offers (or seeks) 
     *  the construction and/or installation of the specified gr:ProductOrService 
     *  at the customer's location.</p>
     */
     ...
     *  gr:BusinessEntity provides the buying party with details on how to retrieve 
     ...
     *  or subcontracted by the gr:BusinessEntity.</p>
     */
    ...
    /** <p>Delivery of the goods by picking them up at one of the stores etc. (gr:Location) 
     *  during the opening hours as specified by respective instances of gr:OpeningHoursSpecification.</p>
     */
    ...
    /** <p>Payment by direct debit, i.e., the buying party will inform the offering gr:BusinessEntity 
     *  about its bank account details and authorizes the gr:BusinessEntity to collect 
     *  the agreed amount directly from that account.</p>
     */
     ...
     *  or any other kind of allowed usages, freeing the current owner from all rights 
    ...
    /** <p>The gr:BusinessEntityType representing such agents that are purchasing the 
    ...
    /** <p>Payment via the Google Checkout payment service.</p> */
    public static final Individual GoogleCheckout = m_model.createIndividual( "http://purl.org/goodrelations/v1#GoogleCheckout", PaymentMethod );
    
    /** <p>Payment by credit or debit cards issued by the JCB network.</p> */
    public static final Individual JCB = m_model.createIndividual( "http://purl.org/goodrelations/v1#JCB", PaymentMethodCreditCard );
    
    /** <p>In case of a defect or malfunction, the buying party has the right to transport 
     *  the good to a service location determined by the the selling gr:BusinessEntity 
     ...
     *  conditions of the gr:WarrantyPromise.</p>
     */
    ...
    /** <p>This gr:BusinessFunction indicates that the gr:BusinessEntity offers (or seeks) 
     *  the temporary right to use the specified gr:ProductOrService.</p>
     */
    ...
    /** <p>This gr:BusinessFunction indicates that the gr:BusinessEntity offers (or seeks) 
     *  typical maintenance tasks for the specified gr:ProductOrService. Maintenance 
     *  tasks are actions that undo or compensate for wear or other deterioriation 
     *  caused by regular usage, in order to restore the originally intended function 
     *  of the product, or to prevent outage or malfunction.</p>
     */
     ...
     *  and terms and conditions of the gr:WarrantyPromise.</p>
     */
     ...
     *  from the selling gr:Business Entity to pick-up the good from its current location 
    ...
    /** <p>Payment via the PaySwarm distributed micropayment service.</p> */
    public static final Individual PaySwarm = m_model.createIndividual( "http://purl.org/goodrelations/v1#PaySwarm", PaymentMethod );
     ...
     *  gr:ProvideService is to be used with such goods that are services, while gr:Maintain 
     *  and gr:Repair can be used with goods for which only the class of product exists 
     *  in the ontology, but not the respective type of service. Example: Car maintenance 
     *  could be expressed both as "provide the service car maintenance" or "maintain 
     *  cars".</p>
     */
    ...
    /** <p>A placeholder for all official public holidays at the gr:Location. This allows 
     *  specifying the opening hours on public holidays. If a given day is a public 
     *  holiday, this specification supersedes the opening hours for the respective 
     *  day of the week.</p>
     */
    ...
    /** <p>The gr:BusinessEntityType representing such agents that are part of the adminstration 
     ...
     *  specified gr:ProductOrService. Repairing means actions that restore the originally 
     *  intended function of a product that suffers from outage or malfunction.</p>
     */
    public static final Individual Repair = m_model.createIndividual( "http://purl.org/goodrelations/v1#Repair", BusinessFunction );
    
    /** <p>The gr:BusinessEntityType representing such agents that are purchasing the 
     *  scope of products included in the gr:Offering for resale on the market. Resellers 
    ...
    /** <p>This gr:BusinessFunction indicates that the gr:BusinessEntity offers to permanently 
     *  transfer all property rights on the specified gr:ProductOrService.</p>
     */
