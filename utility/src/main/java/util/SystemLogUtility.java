 ...
 * @author 4535992
 */
public class SystemLogUtility {

    private static String LOGNAME;
    private static File LOGFILE;
    public static int VERBOSE = 1;
    /** {@code org.slf4j.Logger} */
    private static Logger logger = org.slf4j.LoggerFactory.getLogger(SystemLogUtility.class);
   ...
   // private static SimpleDateFormat logTimesAndDateStamp = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss,SSS");
    ...
    public SystemLogUtility(String LOGNAME, String SUFFIX){
        String timeStamp = new SimpleDateFormat("yyyyMMdd_HHmmss").format(Calendar.getInstance().getTime());
    ...
    public SystemLogUtility(String LOGNAME, String SUFFIX, String PATHFILE){
        String timeStamp = new SimpleDateFormat("yyyyMMdd_HHmmss").format(Calendar.getInstance().getTime());
        this.LOGNAME = LOGNAME +"_"+timeStamp+"."+ SUFFIX;
        this.logging = true;
...
//            return;
    ...
    private static  void setLogWriter()  {
        try {
            ...
            SystemLogUtility.logStackTrace(e, logger);
            e.printStackTrace();
        }
    }
