...
public class UrlLib{
    ...
    /*
    public UrlUtil(Context context, Certificate[] pins) {
    ...
    */
    public UrlLib(Context context,Certificate[] pins) {
        ...
        try {
            ...
            //egistry.register(new Scheme("https", pins != null && !trustSystemKeystore ? mSSLSocketFactory : SSLSocketFactory.getSocketFactory(), 443));
        ...
        */
        ...
        httpclient = new UrlHttpClient(manager, params);
    ...
    public HttpResponse openAsHttpResponse(String url, HttpEntity entity, boolean forcePost) throws ClientProtocolException, IOException {
        if ((entity == null) && !forcePost) {
           return openAsHttpResponse(url,entity,Method.GET);
        }
        else {
           return openAsHttpResponse(url,entity,Method.POST);
        }
    }

    public HttpResponse openAsHttpResponse(String url, Method method) throws ClientProtocolException, IOException {
        return openAsHttpResponse(url, null, method);
    }

    public HttpResponse openAsHttpResponse(String url, HttpEntity entity, Method method) throws ClientProtocolException, IOException {
        this.currentURI = url;
    ...
    class UrlHttpClient extends DefaultHttpClient {

        UrlHttpClient(ClientConnectionManager conman, HttpParams params) {
            super(conman, params);
        }
