...
public class XMLKit {
    ...
    public static Document loadDocumentFromFile(File fileXML) throws SAXException, IOException {
        ...
        //log.write("Documento W3C caricato da file:"+file.getAbsolutePath(),"OUT");
        return doc;
    }
    ...
    public static Document loadDocumentFromFile(String xml) throws SAXException, IOException{
        ...
        //log.write("Documento W3C caricato da file:" + xml,"OUT");
        return doc;
    }
    ...
    public static Document newDocumentXML(){
        ...
        try{
            ...
            //this line of code evite to search the validation parameter
            //just if you want read the xml coe withourt meta information
    ...
    public static void creatXMLFile(String pathFile,String nameFile){
        ...
        try {
            ...
            StreamResult result = new StreamResult(new File(pathFile+"\\"+nameFile));
            // Output to console for testing
            // StreamResult result = new StreamResult(System.out);
            transformer.transform(source, result);
            //log.write("File "+ pathFile+"\\"+nameFile +"saved!","OUT");
    ...
    public static ArrayList getAllAttributes(Element el){
        ArrayList<Attr> listAttr = new ArrayList<Attr>();
        //get map containing the attributes of this node
        NamedNodeMap attributes = el.getAttributes();
        //get the number of nodes in this map
        int numAttrs = attributes.getLength();
        ...
        for(int i =0; i < numAttrs; i++){
            ...
            //String attrNode = attr.getNodeValue();
            listAttr.add(attr);
        }
        return listAttr;
    }
    ...
    public static void readXMLFileAndPrint(File xmlFile) throws IOException, SAXException {
        ...
        //log.write("Root element XML document:" + doc.getDocumentElement().getNodeName(),"OUT");
