...
public class HibernateFinder<T> implements FinderExecutor {
    ...
    private FinderNamingStrategy namingStrategy = new SimpleFinderNamingStrategy(); // Default. Can override in home.home.initializer.org.p4535992.mvc.config
    private FinderArgumentTypeFactory argumentTypeFactory = new SimpleFinderArgumentTypeFactory(); // Default. Can override in home.home.initializer.org.p4535992.mvc.config
